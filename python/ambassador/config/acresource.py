...
class ACResource (Resource):
    ...
    :param label_selected: what label did we select to get this thing?
    ...
    def __init__(self, rkey: str, location: str, *,
        ...
        if label_selected:
            kwargs["label_selected"] = label_selected
    ...
    def from_resource(cls: Type[R], other: R,
        ...
        new_label_selected = label_selected or other.get('label_selected', None)
        ...
        return super().from_resource(other, rkey=rkey, location=location, kind=kind,
                                     ...
                                     label_selected=new_label_selected, serialization=serialization, **kwargs)
